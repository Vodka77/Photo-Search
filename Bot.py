...
def bot_X(message):
    msg = message.text
    url = (f'https://apis.red/api/photo/?word={msg}')
    req = requests.get(url).json()
    phot = req['url'] 
    bot.send_photo(message.chat.id,phot,caption=f'*Done Get The Photo*',parse_mode='markdown') 
bot.polling(True)          
